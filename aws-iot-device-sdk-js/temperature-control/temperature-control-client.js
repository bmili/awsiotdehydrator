...
//              Units: N/A
//              Read/Write
var deviceControlState={ setPoint: 42, enabled: true };
...
//              Read Only
//
var deviceMonitorState={ intTemp: 42, extTemp: 25, curState: 'stopped' };
...
//lcd6.setDisplay('Herbs|Living Foods|Raising Bread|maining Yougurt|Vegetables|Frouits (rols)|Meats/Fish|Jerky');
lcd6.setDisplay('3');
...
var help = blessed.text( {
   ...
   left: 'center',
   align: 'center',
   content: 'Options:1-herbs|2-Raising Bread|3-Making Yougurt|4-Vegetables|5-Fruits(use arrow keys to change temperature)'
} );
...
if (deviceControlState.setPoint1 < 5)
{
   deviceControlState.setPoint1++;
   lcd6.setDisplay(deviceControlState.setPoint1);
   screen.render();
}
});
screen.key('pagedown', function( ch, key ) {
if (deviceControlState.setPoint1 > 1)
{
   deviceControlState.setPoint1--;
   lcd6.setDisplay(deviceControlState.setPoint1);
   screen.render();
